...
public class ModuleScientifique extends ModuleVaisseau {

    public ModuleScientifique(double poids, String nom, double volume, int cout, int dureeMission, int statut,
