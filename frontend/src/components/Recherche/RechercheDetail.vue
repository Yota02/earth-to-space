<template>
    <div class="research-detail-container">
      <div v-if="selectedRecherche" class="research-detail">
        <div class="research-image">
          <img :src="getImageUrl(selectedRecherche.sousCategorie)" :alt="selectedRecherche.nom">
        </div>
  ...
  export default {
    ...
    methods: {
      getImageUrl(sousCategorie) {
        const defaultImages = {
          // Propulsion
          "MOTEURS": "src/assets/img/bandeau/moteur.png",
          "FUEL": "src/assets/img/bandeau/fuel.png",
          "SYSTEMES_DE_PROPULSION": "/images/propulsion-systemes.jpg",
  
          // Exploration
          "CAPTEURS": "/images/exploration-capteurs.jpg",
  
          // Energie
          "PANNEAUX_SOLAIRES": "src/assets/img/bandeau/panneau_solaire.png",
          "REACTEURS": "/images/energie-reacteurs.jpg",
          "BATTERIES": "/images/energie-batteries.jpg",
  
          // Robotique
          "AUTOMATISATION": "/images/robotique-automatisation.jpg",
          "SYSTÈMES_AUTONOMES": "/images/robotique-systemes.jpg",
  
          // Transport Habité
          "SYSTEMES_DE_TRANSPORT": "/images/transport-systemes.jpg",
          "VIE_SPATIALE": "/images/transport-vie.jpg",
  
          // Colonisation
          "INFRASTRUCTURES": "/images/colonisation-infrastructures.jpg",
          "HABITATS": "/images/colonisation-habitats.jpg",
          "AGRICULTURE_SPATIALE": "/images/colonisation-agriculture.jpg",
  
          // Bâtiments
          "CONSTRUCTION": "/images/batiments-construction.jpg",
          "STOCKAGE": "/images/batiments-stockage.jpg"
        };
        return defaultImages[sousCategorie] || "@/../../assets/1.png";
      },
